...
|------------------|------------------|------|
| [Проект 1: Анализ поведения пользователей маркетплейса](https://github.com/annmishkina/game-analytics)) | Retention, product/market fit, гипотезы и оценка метрик продукта. | `Python`, `Pandas`, `Statsmodels`, `Matplotlib`, `Seaborn` |
